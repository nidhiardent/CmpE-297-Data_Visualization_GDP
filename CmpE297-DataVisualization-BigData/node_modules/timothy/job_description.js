...
JobDescription.prototype.execute = function(index, cb) {
    ...
    //Command Changed --- Ankith
    var command = this.configuration.hadoopHome+"/bin/hadoop jar "+this.configuration.hadoopHome+"/share/hadoop/tools/lib/hadoop-streaming-2.2.0.jar ";
    ...
    //Addition
    /*var command2 = this.configuration.hadoopHome+"/bin/hadoop fs -getmerge /user/processed_1412375805496 /tmp/file.txt";
